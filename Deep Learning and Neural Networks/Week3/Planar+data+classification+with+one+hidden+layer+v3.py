...
def compute_cost(A2, Y, parameters):
    ...
    """
    Note: If you want to use logprobs and the cost calculation using log probs, then remove them from 
    comments and at the same time remove the above assert statement from comment and put the one below 
    in comments
    """
